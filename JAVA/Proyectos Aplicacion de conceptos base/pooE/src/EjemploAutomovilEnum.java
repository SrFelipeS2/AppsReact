...
public class EjemploAutomovilEnum {
    public static void main(String[] args) {
        ...
        tipo = mazda.getTipo();
        //Esta es una version mejorada de Switch, solo s eimplementa con -> y no usa break
        switch(tipo){
            case CONVERTIBLE ->
        ...
        //Los enum son iterables, aqui se demustra como se recorren:
        //se crea un arreglo del tipo Automovil, se usa la funcion values() por que devulve un arreglo
        //del enumerador con las constantes
