...
public class EjemploAutomovilStatic {
    public static void main(String[] args) {
        ...
        //este es el ultimo paso para la implementacion del enum, seteamos el valor
        //el por defecto espera un dato de tipo por que asi se lo definimos en la clase Automovil
