package com.avalencia.ejemplo.list;
...
public class EjemploLinkedList {
    public static void main(String[] args) {
        ...
        System.out.println("Indice 4 = " + enlazada.get(4));

        //Alumno zeus = enlazada.pop();
        //enlazada.pollLast();
        //enlazada.pollFirst();
        //enlazada.remove(); elimina el primer elemento, si recibe un indice elimina el indicado.
